...
```bash
pip install kotlin_jupyter_lab
```
...
```bash
pip uninstall kotlin_jupyter_lab
```
...
# Change directory to the kotlin_jupyter_lab directory
...
folder is located. Then you can remove the symlink named `kotlin-jupyter-lab` within that folder.
